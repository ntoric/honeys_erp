    ...
    <Box sx={{ maxWidth: '900px', mx: 'auto' }}>
      <Box sx={{ 
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          <IconButton component={Link} href="/sales/payments" sx={{ backgroundColor: '#ffffff', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
            <ArrowBackIcon />
          </IconButton>
          ...
          <Paper sx={{ p: 4, borderRadius: '24px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', border: '1px solid #f1f5f9' }}>
            ...
            <Grid container spacing={3}>
              ...
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  fullWidth
                  label="Reference No (e.g. UPI ID, Check No)"
            ...
            <Stack spacing={3}>
              <Paper sx={{ p: 4, borderRadius: '24px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', border: '1px solid #f1f5f9' }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                  <Typography sx={{ color: '#64748b', fontWeight: 500 }}>Amount Received</Typography>
                  <Typography sx={{ fontWeight: 700 }}>₹{formData.amount.toLocaleString()}</Typography>
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                  <Typography sx={{ color: '#64748b', fontWeight: 500 }}>Discount Given</Typography>
                  <Typography sx={{ fontWeight: 700, color: '#ef4444' }}>- ₹{formData.discount.toLocaleString()}</Typography>
                </Box>
                <Divider sx={{ my: 2 }} />
